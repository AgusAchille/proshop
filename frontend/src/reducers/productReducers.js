...
export function productDetailsReducer(state = { product: { reviews: [] } }, action){
    switch(action.type) {
        case PRODUCT_DETAILS_REQUEST:
            //BUG: si se saca el ...state se rompe la pantalla de edición de productos, investigar motivo. A Brad no le pasaba.
...
export function productReviewCreateReducer(state = {}, action){
    switch(action.type) {
